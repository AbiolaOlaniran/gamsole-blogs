...
function Contact() {
  ...
  const mailtoUrl = `mailto:${emailAddress}?subject=${encodeURIComponent(formdata.subject)}&body=${encodeURIComponent(formdata.subject)}`
              ...
              <div className="col-lg-6">
                <div className="mi-contact-formwrapper">
                  ...
                  >
                    ...
                    <a href={mailtoUrl} className="mi-form-field mi-button">
                      Send Mail
                    </a>
                  </form>
                  {handleAlerts()}
